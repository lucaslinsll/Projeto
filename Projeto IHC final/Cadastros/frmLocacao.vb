...
Public Class frmLocacao
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnAlocar.Click
        If txtLocador.Text <> "" And txtDias.Text <> "" And txtCodigo.Text <> "" Then
            ...
            If cbCategoria.Text <> "" And txtDisp.Text = "Disponível" Then
                fechar()
    ...
    Private Sub Buscar()
        Try
            ...
            Dim da As MySqlDataAdapter
            Dim sql As String
            sql = "select * from cadastro_ferramenta where desc_ferramenta LIKE '" & txtBuscar.Text & "%' "
        ...
        End Try
    End Sub
    Private Sub cbCategoria_TextChanged(sender As Object, e As EventArgs)
